...
import com.example.zchan_librtmp.JniImp;
...
import androidx.core.content.ContextCompat;
public class LibRTMPActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lib_rtmpactivity);
        viewFinder = findViewById(R.id.viewFinder);
        startCamera();
        JniImp.initFaac(44100, 2);
        JniImp.startRTMP();
        audio_thread.start();
    }
